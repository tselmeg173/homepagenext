...
const TRANSLATIONS = {
  ...
  greeting: "Hi, I'm",
  description: "Hi, I'm Tselmeg — welcome to my homepage.",
  ...
  projectsSub: "Some projects",
  aboutLabel: "About me",
  aboutTitle: "Turning ideas into reality",
  aboutSub: "polished products",
  aboutP1: "I'm a full-stack developer based in Ulaanbaatar with skills in business analysis, data analysis, and system development. I'm continuously improving myself in these areas.",
  aboutP2: "When I'm not coding, I'm exploring new technologies and searching for the next interesting problem to solve.",
  skillsLabel: "Skills",
  skillsTitle: "Tools of the trade",
  contactLabel: "Contact",
  contactTitle: "Let's build something",
  contactSub: "great together",
  contactDesc: "Have a project idea? Send me a message.",
  namePlaceholder: "Name",
  emailPlaceholder: "Email",
  messagePlaceholder: "Message",
  sendBtn: "Send message →",
  sentTitle: "Message sent!",
  sentDesc: "I'll reply within 24 hours.",
  ...
  mn: {
    ...
    greeting: "Сайн уу, би",
    description: "Сайн уу Цэлмэг байна, миний HomePage-д тавтай морил.",
    ...
    projectsSub: "Зарим төслүүд",
    aboutLabel: "Миний тухай",
    aboutTitle: "Санааг бодит болгодог",
    aboutSub: "боловсронгуй бүтээгдэхүүн",
    aboutP1: "Би Улаанбаатар хотод амьдардаг full-stack хөгжүүлэгч бөгөөд бизнес аналист, дата аналист болон систем хөгжүүлэлтийн чиглэлээр ур чадвар эзэмшсэн, энэ чиглэлээрээ өөрийгөө илүү хөгжүүлж байна.",
