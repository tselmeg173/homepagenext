...
const PROJECTS = [
  {
    ...
    desc: "Real-time market data visualization with live charts and portfolio analytics.",
    color: "#00FF94",
  },
  {
    id: "02",
  ...
  },
  {
    ...
    desc: "Conversational AI product with streaming responses and memory management.",
    color: "#00D4FF",
  },
];
...
function RevealSection({ children, style, id }) {
...
function SkillBar({ name, level, delay }) {
  ...
  useEffect(() => {
    const obs = new IntersectionObserver(
      ([e]) => { if (e.isIntersecting) setTimeout(() => setFilled(level), delay); },
      { threshold: 0.3 }
    );
    if (ref.current) obs.observe(ref.current);
    return () => obs.disconnect();
  ...
  return (
    <div ref={ref} style={{ marginBottom: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
        <span style={{ color: "#CBD5E1", fontSize: 14, fontFamily: "'Inter', sans-serif" }}>{name}</span>
...
function ProjectCard({ project }) {
  ...
  return (
    <div
      ...
      style={{
        background: hovered ? "#0F172A" : "#080C14",
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
        <span style={{ color: project.color, fontSize: 13, fontWeight: 700, letterSpacing: 2, fontFamily: "'JetBrains Mono', monospace" }}>
          {project.id}
        </span>
      ...
      <h3 style={{ color: "#F1F5F9", fontSize: 20, fontWeight: 700, marginBottom: 10, fontFamily: "'Inter', sans-serif", lineHeight: 1.3 }}>
        {project.title}
      </h3>
  ...
  return (
    <div style={S.page}>
      ...
      <nav style={S.nav}>
        ...
        <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
          ...
          <button
            ...
            onMouseEnter={(e) => { e.target.style.background = "#00FF9415"; }}
      ...
      <section id="hero" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden", width: "100%" }}>
        ...
        <div style={{ ...S.section, position: "relative", zIndex: 1, paddingTop: 80 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#00FF9412", border: "1px solid #00FF9430", borderRadius: 30, padding: "6px 16px", marginBottom: 32 }}>
            ...
            <span style={{ color: "#00FF94", fontSize: 13, fontWeight: 600, fontFamily: "'JetBrains Mono', monospace" }}>Available for work</span>
          </div>

          <h1 style={{ fontSize: "clamp(42px, 7vw, 80px)", fontWeight: 900, lineHeight: 1.05, marginBottom: 20, letterSpacing: -2 }}>
            Hi, I'm{" "}
            <span style={{ background: "linear-gradient(135deg, #00FF94, #00D4FF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              Tselmeg
            </span>
            <br />
            <span style={{ color: "#94A3B8", fontSize: "clamp(28px, 4.5vw, 52px)", fontWeight: 700 }}>
              {typed}
              <span style={{ color: "#00FF94", animation: "blink 1s step-end infinite" }}>|</span>
            </span>
          </h1>

          <p style={{ color: "#64748B", fontSize: 18, maxWidth: 560, lineHeight: 1.8, marginBottom: 48 }}>
            I build fast, beautiful digital products — from concept to deployment. Focused on clean code and exceptional user experience.
          </p>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            <button
              ...
              style={{
                background: "#00FF94", color: "#030712", border: "none",
                padding: "16px 32px", borderRadius: 10, fontSize: 15, fontWeight: 700,
                cursor: "pointer", transition: "all 0.2s", boxShadow: "0 0 30px #00FF9440",
              }}
              onMouseEnter={(e) => { e.target.style.transform = "translateY(-2px)"; e.target.style.boxShadow = "0 0 50px #00FF9460"; }}
              onMouseLeave={(e) => { e.target.style.transform = "none"; e.target.style.boxShadow = "0 0 30px #00FF9440"; }}
            >
              View my work →
            </button>
            <button
              onClick={() => scrollTo("contact")}
              style={{
                background: "transparent", color: "#F1F5F9", border: "1px solid #1E293B",
        ...
        <div style={{ position: "absolute", bottom: 32, left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
          <span style={{ color: "#475569", fontSize: 11, letterSpacing: 2, textTransform: "uppercase" }}>Scroll</span>
      ...
      <RevealSection id="work" style={{ padding: "120px 0", width: "100%" }}>
        <div style={S.section}>
          <div style={{ marginBottom: 60 }}>
            <span style={{ color: "#00FF94", fontSize: 13, fontWeight: 700, letterSpacing: 3, fontFamily: "'JetBrains Mono', monospace", textTransform: "uppercase" }}>Selected Work</span>
            <h2 style={{ fontSize: "clamp(32px, 4vw, 52px)", fontWeight: 800, marginTop: 12, letterSpacing: -1 }}>
              Projects that<br />
              <span style={{ color: "#475569" }}>speak for themselves</span>
            </h2>
          </div>
      ...
      <RevealSection id="about" style={{ padding: "120px 0", position: "relative", width: "100%" }}>
        ...
        <div style={{ ...S.section, position: "relative", zIndex: 1 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            <div>
              <span style={{ color: "#00FF94", fontSize: 13, fontWeight: 700, letterSpacing: 3, fontFamily: "'JetBrains Mono', monospace", textTransform: "uppercase" }}>About me</span>
              ...
              <p style={{ color: "#64748B", fontSize: 16, lineHeight: 1.9, marginBottom: 20 }}>
                I'm a full-stack developer based in Ulaanbaatar with a passion for building things that live on the internet. I enjoy working at the intersection of design and engineering.
              </p>
              <p style={{ color: "#64748B", fontSize: 16, lineHeight: 1.9, marginBottom: 36 }}>
                When I'm not coding, I'm exploring new technologies, contributing to open-source projects, and always looking for the next interesting problem to solve.
              </p>
              <div style={{ display: "flex", gap: 16 }}>
                {["GitHub", "LinkedIn", "Twitter"].map((s) => (
                  <span key={s} style={{
                    color: "#94A3B8", fontSize: 13, fontWeight: 600, cursor: "pointer",
                    borderBottom: "1px solid #334155", paddingBottom: 2, transition: "color 0.2s",
                  }}
                    onMouseEnter={(e) => e.target.style.color = "#00FF94"}
                    onMouseLeave={(e) => e.target.style.color = "#94A3B8"}
                  >{s} ↗</span>
            ...
            <div style={{ position: "relative" }}>
              <div style={{
                ...
                <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(circle at 30% 30%, #00FF9410, transparent 60%)" }} />
              </div>
              <div style={{
                position: "absolute", bottom: -16, right: -16,
                background: "#0F172A", border: "1px solid #00FF9430",
                borderRadius: 12, padding: "12px 20px",
                display: "flex", alignItems: "center", gap: 10,
              }}>
                <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#00FF94", boxShadow: "0 0 8px #00FF94" }} />
                <span style={{ color: "#F1F5F9", fontSize: 13, fontWeight: 600 }}>Open to opportunities</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <RevealSection id="skills" style={{ padding: "120px 0", width: "100%" }}>
        <div style={S.section}>
          <span style={{ color: "#00FF94", fontSize: 13, fontWeight: 700, letterSpacing: 3, fontFamily: "'JetBrains Mono', monospace", textTransform: "uppercase" }}>Skills</span>
          <h2 style={{ fontSize: "clamp(28px, 3.5vw, 44px)", fontWeight: 800, marginTop: 12, marginBottom: 60, letterSpacing: -1 }}>
            Tools of the trade
          </h2>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginTop: 48 }}>
            {["PostgreSQL", "Redis", "AWS", "Tailwind CSS", "GraphQL", "Figma", "Git", "Linux"].map((t) => (
              <span key={t} style={{
                ...
                onMouseEnter={(e) => { e.target.style.borderColor = "#00FF9450"; e.target.style.color = "#00FF94"; }}
      ...
      <RevealSection id="contact" style={{ padding: "120px 0 80px", width: "100%" }}>
        <div style={{ ...S.section, maxWidth: 700 }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <span style={{ color: "#00FF94", fontSize: 13, fontWeight: 700, letterSpacing: 3, fontFamily: "'JetBrains Mono', monospace", textTransform: "uppercase" }}>Contact</span>
            <h2 style={{ fontSize: "clamp(28px, 4vw, 52px)", fontWeight: 800, marginTop: 12, letterSpacing: -1 }}>
              Let's build something<br />
              <span style={{ color: "#475569" }}>great together</span>
            </h2>
            <p style={{ color: "#64748B", fontSize: 16, marginTop: 16, lineHeight: 1.7 }}>
          ...
          {sent ? (
            <div style={{ background: "#00FF9410", border: "1px solid #00FF9430", borderRadius: 16, padding: "48px 32px", textAlign: "center" }}>
              ...
              <h3 style={{ color: "#00FF94", fontSize: 22, fontWeight: 700, marginBottom: 8 }}>Message sent!</h3>
              <p style={{ color: "#64748B" }}>I'll get back to you within 24 hours.</p>
              <button onClick={() => setSent(false)} style={{
                marginTop: 24, background: "transparent", border: "1px solid #00FF9430",
                color: "#00FF94", padding: "10px 24px", borderRadius: 8, cursor: "pointer", fontSize: 14,
              }}>Send another</button>
            </div>
          ) : (
            <div style={{ background: "#080C14", border: "1px solid #1E293B", borderRadius: 20, padding: 40 }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 20 }}>
                <div>
                  <label style={{ display: "block", color: "#94A3B8", fontSize: 13, marginBottom: 8, fontWeight: 500 }}>Name</label>
                  <input style={inputStyle} placeholder="Bat-Erdene" value={formData.name}
                ...
                <div>
                  ...
                  <input style={inputStyle} placeholder="bat@example.com" value={formData.email}
              ...
              <div style={{ marginBottom: 28 }}>
                <label style={{ display: "block", color: "#94A3B8", fontSize: 13, marginBottom: 8, fontWeight: 500 }}>Message</label>
              ...
              <button onClick={handleSend} style={{
                width: "100%", background: "#00FF94", color: "#030712", border: "none",
                padding: "16px", borderRadius: 10, fontSize: 15, fontWeight: 700,
                cursor: "pointer", transition: "all 0.2s", boxShadow: "0 0 30px #00FF9440",
              }}
                onMouseEnter={(e) => { e.target.style.boxShadow = "0 0 50px #00FF9460"; }}
                onMouseLeave={(e) => { e.target.style.boxShadow = "0 0 30px #00FF9440"; }}
              >
                Send message →
              </button>
            </div>
      ...
      <footer style={{ borderTop: "1px solid #1E293B", padding: "32px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
          <div style={{ color: "#475569", fontSize: 13 }}>
            © 2026 <span style={{ color: "#00FF94" }}>&lt;Dev/&gt;</span> — Built with React
          </div>
      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        html, body, #root { width: 100%; overflow-x: hidden; background: #030712; }
