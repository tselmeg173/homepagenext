    ...
    <div style={S.page}>
        ...
        <div style={S.section}>
          <div style={{ marginBottom: 60 }}>
            ...
            <h2 style={{ fontSize: "clamp(32px, 4vw, 52px)", fontWeight: 800, marginTop: 12, letterSpacing: -1 }}>
              Projects that<br /><span style={{ color: "#475569" }}>speak for themselves</span>
            </h2>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            <div>
              ...
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 44px)", fontWeight: 800, marginTop: 12, marginBottom: 24, letterSpacing: -1 }}>
                ...
                <span style={{ background: "linear-gradient(135deg, #00FF94, #00D4FF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>polished products</span>
              </h2>
              <p style={{ color: "#64748B", fontSize: 16, lineHeight: 1.9, marginBottom: 20 }}>
                I&apos;m a full-stack developer based in Ulaanbaatar with a passion for building things that live on the internet.
              </p>
              <p style={{ color: "#64748B", fontSize: 16, lineHeight: 1.9, marginBottom: 36 }}>
                When I&apos;m not coding, I&apos;m exploring new technologies and always looking for the next interesting problem to solve.
              </p>
      ...
      <RevealSection id="skills" style={{ padding: "120px 0", width: "100%" }}>
        <div style={S.section}>
          ...
          <h2 style={{ fontSize: "clamp(28px, 3.5vw, 44px)", fontWeight: 800, marginTop: 12, marginBottom: 60, letterSpacing: -1 }}>Tools of the trade</h2>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginTop: 48 }}>
            {["PostgreSQL", "Redis", "AWS", "Tailwind CSS", "GraphQL", "Figma", "Git", "Linux"].map((t) => (
              <span key={t} style={{ background: "#0F172A", border: "1px solid #1E293B", color: "#94A3B8", padding: "8px 16px", borderRadius: 8, fontSize: 13, fontFamily: "'JetBrains Mono', monospace", transition: "all 0.2s", cursor: "default" }}
        ...
        <div style={{ ...S.section, maxWidth: 700 }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <h2 style={{ fontSize: "clamp(28px, 4vw, 52px)", fontWeight: 800, marginTop: 12, letterSpacing: -1 }}>
              Let&apos;s build something<br /><span style={{ color: "#475569" }}>great together</span>
            </h2>
            <p style={{ color: "#64748B", fontSize: 16, marginTop: 16, lineHeight: 1.7 }}>Have a project in mind? Drop me a message.</p>
          </div>
          ...
          {sent ? (
            <div style={{ background: "#00FF9410", border: "1px solid #00FF9430", borderRadius: 16, padding: "48px 32px", textAlign: "center" }}>
              ...
              <button onClick={() => setSent(false)} style={{ marginTop: 24, background: "transparent", border: "1px solid #00FF9430", color: "#00FF94", padding: "10px 24px", borderRadius: 8, cursor: "pointer", fontSize: 14 }}>Send another</button>
            </div>
          ) : (
            <div style={{ background: "#080C14", border: "1px solid #1E293B", borderRadius: 20, padding: 40 }}>
              ...
              <div style={{ marginBottom: 28 }}>
                ...
                <textarea style={{ ...inputStyle, height: 140, resize: "vertical" }} placeholder="Tell me about your project..." value={formData.message}
      ...
      <footer style={{ borderTop: "1px solid #1E293B", padding: "32px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
          <div style={{ color: "#475569", fontSize: 13 }}>© 2026 <span style={{ color: "#00FF94" }}>&lt;Dev/&gt;</span> — Built with Next.js</div>
